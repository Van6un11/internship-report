...
> Numbering matches the badges in the architecture diagram exactly. Steps 1–13 are the request/booking and payment flows (solid arrows); steps 14–22 are the operational and CI/CD flows (dashed arrows).
